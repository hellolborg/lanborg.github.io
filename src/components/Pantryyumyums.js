    ...
    return (
        <section className={styles.pantryYY}>
            <div className={styles.controls}>
                <a href="./fox">&#60; Previous</a>
                <a href="./fxtrade">Next &#62;</a>
            </div>
            ...
            <a href="https://fervent-northcutt-df7533.netlify.app/" className={styles.pantryLink}>Check out Pantry Yum Yums Live!</a>
